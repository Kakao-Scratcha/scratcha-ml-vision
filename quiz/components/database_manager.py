    ...
    def init_database(self):
        ...
        try:
            ...
            CREATE TABLE IF NOT EXISTS captcha_problem (
                ...
                origin_image_url TEXT NULL COMMENT '원본 이미지 경로',
    ...
    def save_quiz_to_database(self, quiz_data: Dict):
        ...
        with self._lock:  # 스레드 안전성을 위한 락
            ...
            try:
                ...
                (image_url, origin_image_url, answer, prompt, created_at, expires_at, difficulty, 
                ...
                quiz_record = (
                    ...
                    quiz_data.get('original_image_path', ''),  # origin_image_url (원본 이미지 경로)
